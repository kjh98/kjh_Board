package codinghub.assignment.study.board;
...
public class BoardTest {
    ...
    void save() {
        ...
        assertThat(entity.getWriter()).isEqualTo("kjh");
    }
    ...
    @Test
    void findRelatedPosted() {
        // 1. 전체 게시글 수 조회
        List<Board> relatedPosts = boardRepository.FindRelatedPosts(12L);



//        System.out.println("title = " + title);
//        System.out.println("createdDate = " + createdDate);
        System.out.println("createdDate = " + relatedPosts.get(0).getTitle());
